var Datepicker = function() {
    ...
    function x(e) {
        ...
        const a = s.map(e => v[e]),
            n = Object.keys(D).reduce((e, t) => {
                return s.find(e => e[0] === t) ? (e[t] = D[t], e) : e
            }, {}),
            r = Object.keys(n);
        return k[e] = {
            parser(e, t) {
    ...
    function q(t, s) {
        ...
        if (a.language) {
            ...
            if (a.language !== o && (r[a.language] ? e = a.language : void 0 === r[e = a.language.split("-")[0]] && (e = !1)), delete a.language, e) {
                ...
                c = Object.assign({
                    format: H,
                    weekStart: $
                }, r[T]), o !== T && Object.assign(c, r[o]), n.locale = c, d === t.format && (d = n.format = c.format), g === t.weekStart && (g = n.weekStart = c.weekStart, n.weekEnd = _(c.weekStart))
            }
        }
        if (a.format) {
        ...
        let y = f,
            k = h;
        if (void 0 !== a.minDate && (y = null === a.minDate ? l(0, 0, 1) : P(a.minDate, d, c, y), delete a.minDate), void 0 !== a.maxDate && (k = null === a.maxDate ? void 0 : P(a.maxDate, d, c, k), delete a.maxDate), k < y ? (f = n.minDate = k, h = n.maxDate = y) : (f !== y && (f = n.minDate = y), h !== k && (h = n.maxDate = k)), a.datesDisabled && (n.datesDisabled = a.datesDisabled.reduce((e, t) => {
                const s = M(t, d, c);
        ...
        if (void 0 !== a.weekStart) {
            ...
            isNaN(e) || (g = n.weekStart = e, n.weekEnd = _(e)), delete a.weekStart
        }
        if (a.daysOfWeekDisabled && (n.daysOfWeekDisabled = a.daysOfWeekDisabled.reduce(j, []), delete a.daysOfWeekDisabled), a.daysOfWeekHighlighted && (n.daysOfWeekHighlighted = a.daysOfWeekHighlighted.reduce(j, []), delete a.daysOfWeekHighlighted), void 0 !== a.maxNumberOfDates) {
        ...
        let b = m;
        if (void 0 !== a.startView && (b = I(a.startView, b), delete a.startView), b < p ? b = p : b > u && (b = u), b !== m && (n.startView = b), a.prevArrow) {
    ...
    class X extends z {
        ...
        setOptions(t) {
            ...
            void 0 !== t.showDaysOfWeek && (t.showDaysOfWeek ? (A(this.dow), this.calendarWeeks && A(this.calendarWeeks.dow)) : (W(this.dow), this.calendarWeeks && W(this.calendarWeeks.dow))), i && Array.from(this.dow.children).forEach((e, t) => {
    ...
    class Z extends z {
        ...
        updateFocus() {
            const e = new Date(this.picker.viewDate),
                t = g(e, this.navStep),
                i = t + 9 * this.step;
            this.first = t, this.last = i, this.start = t - this.step, this.switchLabel = `${t}-${i}`, this.focused = g(e, this.step)
        }
        updateSelection() {
            const {
                dates: e,
            ...
            this.selected = e.reduce((e, t) => i(e, g(t, this.step)), []), t && t.dates && (this.range = t.dates.map(e => {
    ...
    function ne(t, i) {
        if (void 0 !== i.title && (i.title ? (t.controls.title.textContent = i.title, A(t.controls.title)) : (t.controls.title.textContent = "", W(t.controls.title))), i.prevArrow) {
        ...
        if (i.locale && (t.controls.todayBtn.textContent = i.locale.today, t.controls.clearBtn.textContent = i.locale.clear), void 0 !== i.todayBtn && (i.todayBtn ? A(t.controls.todayBtn) : W(t.controls.todayBtn)), e(i, "minDate") || e(i, "maxDate")) {
            const {
                minDate: e,
                maxDate: i
            } = t.datepicker.config;
        ...
        void 0 !== i.clearBtn && (i.clearBtn ? A(t.controls.clearBtn) : W(t.controls.clearBtn))
    }
    ...
    class ce {
        constructor(e) {
            ...
            i.classList.add(`datepicker-${p}`), ne(this, e.config), this.viewDate = re(e), F(e, [
                [i, "click", function(e) {
            ...
            ]), this.views = [new X(this), new Q(this), new Z(this, {
                id: 2,
                name: "years",
                cellClass: "year",
                step: 1
        ...
        show() {
            ...
            if (!e.inline) {
                ...
                t !== oe(e.config.container) ? this.element.dir = t : this.element.dir && this.element.removeAttribute("dir"), this.place(), e.config.disableTouchKeyboard && e.inputField.blur()
            }
            ee(e, "show")
        }
        hide() {
        ...
        place() {
            ...
            a === document.body ? (p = window.scrollY, m = l + window.scrollX, g = h + p) : (m = l - d, g = h - o + (p = a.scrollTop)), "auto" === w && (m < 0 ? (w = "left", m = 10) : w = m + n > c ? "right" : "rtl" === oe(s) ? "right" : "left"), "right" === w && (m -= n - u), "auto" === y && (y = g - r < p ? "bottom" : "top"), "top" === y ? g -= r : g += f, e.remove("datepicker-orient-top", "datepicker-orient-bottom", "datepicker-orient-right", "datepicker-orient-left"), e.add(`datepicker-orient-${y}`, `datepicker-orient-${w}`), t.top = g ? `${g}px` : g, t.left = m ? `${m}px` : m
        }
        ...
        changeFocus(e) {
            return this._renderMethod = de(this, e) ? "render" : "refreshFocus", this.views.forEach(e => {
                e.updateFocus()
            }), this
        }
        update() {
            const e = re(this.datepicker);
            return this._renderMethod = de(this, e) ? "render" : "refresh", this.views.forEach(e => {
    ...
    function le(e, t, i, s) {
        ...
        switch (r.id) {
            ...
            case 1:
                ...
                break;
            default:
                l = f(l, i * (s ? 4 : 1) * d), o = f, c = (e => r.disabled.includes(g(e, d)))
        }
    ...
    function ue(e, t, i = !1) {
        ...
        let o = t.reduce((e, t) => {
            ...
            if (s.pickLevel > 0) {
                const e = new Date(i);
                i = 1 === s.pickLevel ? d ? e.setMonth(e.getMonth() + 1, 1) - 864e5 : e.setDate(1) : d ? e.setFullYear(e.getFullYear() + 1, 0, 1) - 864e5 : e.setMonth(0, 1)
            }
    ...
    return class {
        constructor(e, t = {}, i) {
            ...
            if (i && "DateRangePicker" === i.constructor.name) {
                const e = Number(i.inputs[1] === r);
                i.datepickers[e] = this, Object.defineProperty(this, "rangepicker", {
                    get: () => i
                })
            }
            this.dates = ue(this, d) || [], r && (r.value = he(this.dates, a));
            const o = this.picker = new ce(this);
            if (n) this.show();
            else {
